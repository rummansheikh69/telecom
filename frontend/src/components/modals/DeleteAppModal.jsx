...
export default function DeleteAppModal({ onDeleteSuccess }) {
  const [isOpen, setIsOpen] = useState(false);
  const [itemData, setItemData] = useState(null);

  const modalId = "delete_app_modal";
    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-slate-600">
          Are you sure you want to delete this app from the App Store directory?
        </p>
